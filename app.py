from flask import Flask, render_template, request, send_file, jsonify, current_app, redirect, url_for
import os
...
def index(filename_plate_carree=None, filename_azimuthal_equidistant=None):
    location1_str = ["", "", ""]
    location2_str = ["", "", ""]
    location3_str = ["", "", ""]
    location4_str = ["", "", ""]
